...
public class mainwindow extends javax.swing.JFrame {
			...
			switch(confirm)
				{
	   				...
	   				String unixCommand = "service dhcpd restart>/dev/null"; 
        ...
        jButton15.addActionListener(new java.awt.event.ActionListener()
	{
		...
		try{
		String unixCommand = "bash dhcps.sh"; 
		runShellScript(unixCommand);
        ...
        jButton19.addActionListener(new java.awt.event.ActionListener()
	{
		...
		try{
		String unixCommand = "bash dnss.sh"; 
		runShellScript(unixCommand);
        ...
        jButton23.addActionListener(new java.awt.event.ActionListener()
	{
		...
		try{
		String unixCommand = "bash https.sh"; 
		runShellScript(unixCommand);
        ...
        jButton27.addActionListener(new java.awt.event.ActionListener()
	{
		...
		try{
		String unixCommand = "bash ftps.sh"; 
		runShellScript(unixCommand);
        ...
        jButton31.addActionListener(new java.awt.event.ActionListener()
	{
		...
		final String dir = System.getProperty("user.dir");
		try{
		String unixCommand = "bash nfss.sh"; 
		runShellScript(unixCommand);
