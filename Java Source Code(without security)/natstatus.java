 ...
 * @author subhra
 */
public class natstatus extends javax.swing.JFrame {

    /**
     * Creates new form natstatus
     */
    public natstatus() {
        initComponents();
    }
	...
	String str_status;
	try{
	BufferedReader br1=new BufferedReader(new FileReader("/etc/Network_Builder_V0.1/logs/NAT/natk.status"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(natstatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
