 ...
 * @author subhra
 */
public class dhcpframe extends javax.swing.JFrame {

    /**
     * Creates new form dhcpframe
     */
    public dhcpframe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setFont(new java.awt.Font("Century Schoolbook L", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Choose Interface", "eth0", "eth1", "eth2", "eth3", "eth4" }));
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener()
	 {
	    public void runShellScript(String unixCommand) throws IOException, InterruptedException
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt)
		 {
			...
			String st_ip = new String(jTextField1.getText());
			String sb_nt= new String(jTextField2.getText());
			String nt_msk= new String(jTextField3.getText());
			String gt_wy= new String(jTextField4.getText());
			String s_ip= new String(jTextField5.getText());
			String e_ip= new String(jTextField6.getText());
			try{
	                jButton1ActionPerformed(evt);
			if(nic_name.equals("") || st_ip.equals("") || sb_nt.equals("") || nt_msk.equals("") || gt_wy.equals("") || s_ip.equals("") || e_ip.equals("")) 
				{
				...
				BufferedWriter fileOut = new BufferedWriter(new FileWriter("/etc/Network_Builder_V0.1/logs/DHCP/dhcpk.log"));
				...
				fileOut.write(jTextField6.getText());
				 ...
				 String unixCommand = "bash dhcp.sh "+nic_name+" "+st_ip+" "+sb_nt+" "+nt_msk+" "+gt_wy+" "+s_ip+" "+e_ip; 
				...
				BufferedReader br1=new BufferedReader(new FileReader("/etc/Network_Builder_V0.1/logs/DHCP/dhcpk.log"));
				BufferedReader br2=new BufferedReader(new FileReader("/etc/Network_Builder_V0.1/logs/DHCP/dhcpk.msg"));
		...
		try{
		String unixCommand = "java Encrypter dhcp.sh "+dir; 
		runShellScript(unixCommand);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dhcpframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
