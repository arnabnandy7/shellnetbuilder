 ...
 * @author subhra
 */
public class dnsstatus extends javax.swing.JFrame {

    /**
     * Creates new form dnsstatus
     */
    public dnsstatus() {
        initComponents();
    }
	...
	setTitle("Network Builder V0.1| DNS Status Window");
		...
		try{
		String unixCommand = "java Encrypter dnss.sh "+dir; 
		runShellScript(unixCommand);
		unixCommand = "rm -f dnss.sh"; 
		runShellScript(unixCommand);
		}
		catch(Exception e){}
		dispose();
        ...
        jLabel2.setText("Server Configuration Tool RHLv0.1");
	
	String str_status;
	try{

	BufferedReader br1=new BufferedReader(new FileReader("/etc/Network_Builder_V0.1/logs/DNS/dnsk.status"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dnsstatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
