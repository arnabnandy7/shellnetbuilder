 ...
 * @author subhra
 */
public class nfsstatus extends javax.swing.JFrame {

    /**
     * Creates new form nfsstatus
     */
    public nfsstatus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Network Builder V0.1 | NFS Status");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Century Schoolbook L", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(44, 141, 212));
        jLabel1.setText("NFS Server Status");
        jLabel1.setToolTipText("Shared Directory Running Status");
		...
		try{
		String unixCommand = "java Encrypter nfss.sh "+dir; 
		runShellScript(unixCommand);
		unixCommand = "rm -f nfss.sh"; 
		runShellScript(unixCommand);
		}
		catch(Exception e){}
		dispose();
	...
	String str_status;
	try{
	BufferedReader br1=new BufferedReader(new FileReader("/etc/Network_Builder_V0.1/logs/NFS/nfsk.status"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nfsstatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
