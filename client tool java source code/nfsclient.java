...
public class nfsclient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Shared Path *");
        jLabel3.setToolTipText("Server Shared Directory");
        ...
        jLabel4.setText("Mount Path *");
        jLabel4.setToolTipText("Client Directory Path Where Shared Directory Will be Mounted");
        ...
        jTextArea1.setForeground(new java.awt.Color(42, 99, 225));
	    ...
	    {
            	String s_ip = new String(jTextField1.getText());
		String s_path = new String(jTextField2.getText());
		String c_path = new String(jTextField3.getText());
		try{
			...
			{
				BufferedWriter fileOut = new BufferedWriter(new FileWriter("/etc/Tools/cnfsk.log"));
				...
				String str1,str2;
				str1="Complete Configuration! Server Directory Mounted Successfully";
				BufferedWriter bw1 = new BufferedWriter(new FileWriter("/etc/Tools/cnfsk.msg"));
				bw1.write(str1);
				bw1.newLine(); 
				bw1.close();
				...
				BufferedReader br1=new BufferedReader(new FileReader("/etc/Tools/cnfsk.msg"));
		...
		try{
		String unixCommand = "java Encrypter nfs-client.sh "+dir; 
		runShellScript(unixCommand);
		unixCommand = "rm -f nfs-client.sh"; 
		runShellScript(unixCommand);
		}
		catch(Exception e){}
		dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nfsclient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
